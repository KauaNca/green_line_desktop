...
public class TelaInicial extends JFrame {
    ...
    private void configurarEventos() {
        ...
        cadastroUsuario.addActionListener(e -> centralizarTela(new CadastroPessoas(codigo)));
        editarUsuario.addActionListener(e -> centralizarTela(new EditarUsuarios(codigo)));
    }
