            ...
            try (ResultSet rs = stmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    if (tipo_usuario.equals("1") && situacao.equals("A")) {
                        ...
                        JOptionPane.showMessageDialog(null, "Usuário sem permissão de acesso. Contate a administração para mais informações");
                        limpar();
                    }
                } else {
                    LOGGER.warning("Credenciais inválidas para usuário: " + usuario.getText());
                    JOptionPane.showMessageDialog(null, "Credenciais inválidas para usuário");
                    limpar();
                }
            }
